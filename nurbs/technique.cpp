...
void AbstractTechnique::glPass( Texture* pSource, RenderTarget* pDest, ScreenQuad* pSQuad ){
  if( pDest )
    ...
    // TODO: CHANGE THIS..
    glViewport( 0,0, 640, 480 );// BAD, BAD IDEA... change ASAP.
  }
...
void AbstractTechnique::loadUniformsFromObject( Object* o ){

}
void AbstractTechnique::glDrawObject( Object* o ){
  this->loadUniformsFromObject(o);
  this->glTransferUniforms();
  o->glDraw();
}
...
void AbstractTechnique::load( const std::string& str_vs, const std::string& str_fs ){
  ...
  void WVPBasedTechnique::loadUniformsFromObject( Object* o ){
    matWorld = o->getWorldMatrix();
